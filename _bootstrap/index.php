...
if (!createObject('modNamespace',array(
    'name' => 'commerce_wipay',
    'path' => $componentPath.'/core/components/commerce_wipay/',
    'assets_path' => $componentPath.'/assets/components/commerce_wipay/',
),'name', false)) {
    echo "Error creating namespace commerce_wipay.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_wipay.core_path',
    'value' => $componentPath.'/core/components/commerce_wipay/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_wipay',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_wipay.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_wipay.assets_path',
    'value' => $componentPath.'/assets/components/commerce_wipay/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_wipay',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_wipay.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_wipay/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_wipay.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_wipay',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_wipay.assets_url setting.\n";
}
...
include $componentPath . '/core/components/commerce_wipay/vendor/autoload.php';
